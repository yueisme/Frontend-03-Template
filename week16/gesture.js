...
export class Listener {
  constructor(element, recognizer) {
    ...
    element.addEventListener("touchmove", (tmEvent) => {
      for (const touch of tmEvent.changedTouches) {
        //console.log(touch);
    ...
    element.addEventListener("touchend", (teEvent) => {
      for (const touch of teEvent.changedTouches) {
        //console.log(touch);
        let context = contexts.get(touch.identifier);
    ...
    element.addEventListener("touchcancel", (tcEvent) => {
      for (const touch of tcEvent.changedTouches) {
        //console.log(touch);
        let context = contexts.get(touch.identifier);
